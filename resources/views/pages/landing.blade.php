            ...
            <section class="mx-auto max-w-screen-2xl px-4 md:px-8">
              <div class="mb-8 flex flex-wrap justify-between md:mb-16">
                <div class="mb-6 flex w-full flex-col justify-center sm:mb-12 lg:mb-0 lg:w-1/3 lg:pt-48 lg:pb-24">
                  <h1 class="text-black-800 mb-4 text-4xl font-bold sm:text-5xl md:mb-8 md:text-6xl">VAPE Mi<br /></h1>

                  <p class="max-w-md leading-relaxed text-gray-500 xl:text-lg">VAPE Mi is the ultimate destination for rockbottom prices on the best vape juice flavors and brands from Malaysia. Shop direct and enjoy maximum savings on premium e juice, e-liquids, bundles, vape deals and more. We test all ejuices in-house to filter only the best that the Malaysian vape scene has to offer and are headquartered in Kuala Lumpur..</p>
                </div>
                ...
                <div class="mb-12 flex w-full md:mb-16 lg:w-2/3">
                  <div class="relative top-12 left-12 z-10 -ml-12 overflow-hidden rounded-lg bg-gray-100 shadow-lg md:top-16 md:left-16 lg:ml-0">
                    <img src="{{ asset('assets/img/vapelogo3.jpg') }}" loading="lazy" alt="Photo by Kaung Htet" class="h-full w-full object-cover object-center" />
                  </div>

                  <div class="overflow-hidden rounded-lg bg-gray-100 shadow-lg">
                    <img src="assets/img/vapelogo2.jpg" loading="lazy" alt="Photo by Manny Moreno" class="h-full w-full object-cover object-center" />
                  </div>
                </div>
              </div>
              ...
              <div class="flex flex-col items-center justify-between gap-8 md:flex-row">
                <div class="flex h-12 w-64 divide-x overflow-hidden rounded-lg border">
                  <a href="#" class="flex w-1/3 items-center justify-center text-gray-500 transition duration-100 hover:bg-gray-100 active:bg-gray-200">Vape</a>
                  <a href="#" class="flex w-1/3 items-center justify-center text-gray-500 transition duration-100 hover:bg-gray-100 active:bg-gray-200">Pod</a>
                  <a href="#" class="flex w-1/3 items-center justify-center text-gray-500 transition duration-100 hover:bg-gray-100 active:bg-gray-200">Mod</a>
                </div>

                <!-- social - start -->
                <div class="flex items-center justify-center gap-4 lg:justify-start">
                  <span class="text-sm font-semibold uppercase tracking-widest text-gray-400 sm:text-base">Media</span>
    ...
    <div class="bg-white py-6 sm:py-8 lg:py-12">
        <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
          <div class="mb-6 flex items-end justify-between gap-4">
            <h2 class="text-2xl font-bold text-gray-800 lg:text-3xl">All Products</h2>
          ...
          <div class="grid gap-x-4 gap-y-8 sm:grid-cols-2 md:gap-x-6 lg:grid-cols-3 xl:grid-cols-4">
            ...
            <div>
              <a href="#" class="group relative mb-2 block h-80 overflow-hidden rounded-lg bg-gray-100 lg:mb-3">
                <img src="assets/img/Dotbot.jpg" loading="lazy" alt="Photo by Rachit Tank" class="h-full w-full object-cover object-center transition duration-200 group-hover:scale-110" />

              </a>

              <div>
                <a href="#" class="hover:gray-800 mb-1 text-gray-500 transition duration-100 lg:text-lg">DotPod</a>

                <div class="flex items-end gap-2">
                  <span class="font-bold text-gray-800 lg:text-lg">RM299.99</span>
                </div>
              </div>
            </div>
            <!-- product - end -->
            ...
            <div>
              <a href="#" class="group relative mb-2 block h-80 overflow-hidden rounded-lg bg-gray-100 lg:mb-3">
                <img src="assets/img/NanoStix.png" loading="lazy" alt="Photo by Galina N" class="h-full w-full object-cover object-center transition duration-200 group-hover:scale-110" />
              </a>

              <div>
                <a href="#" class="hover:gray-800 mb-1 text-gray-500 transition duration-100 lg:text-lg">NanaStix Black Edition</a>

                <div class="flex items-end gap-2">
                  <span class="font-bold text-gray-800 lg:text-lg">RM199.99</span>
                </div>
              </div>
            </div>
            <!-- product - end -->
            ...
            <div>
              <a href="#" class="group relative mb-2 block h-80 overflow-hidden rounded-lg bg-gray-100 lg:mb-3">
                <img src="assets/img/VoltMi.jpg" loading="lazy" alt="Photo by eniko kis" class="h-full w-full object-cover object-center transition duration-200 group-hover:scale-110" />
              </a>

              <div>
                <a href="#" class="hover:gray-800 mb-1 text-gray-500 transition duration-100 lg:text-lg">VoltMi</a>

                <div class="flex items-end gap-2">
                  <span class="font-bold text-gray-800 lg:text-lg">RM59.99</span>
                </div>
              </div>
            </div>
            <!-- product - end -->
            ...
            <div>
              <a href="#" class="group relative mb-2 block h-80 overflow-hidden rounded-lg bg-gray-100 lg:mb-3">
                <img src="assets/img/vapetape.jpg" loading="lazy" alt="Photo by Irene Kredenets" class="h-full w-full object-cover object-center transition duration-200 group-hover:scale-110" />
              </a>

              <div>
                <a href="#" class="hover:gray-800 mb-1 text-gray-500 transition duration-100 lg:text-lg">Vape Tape</a>

                <div class="flex items-end gap-2">
                  <span class="font-bold text-gray-800 lg:text-lg">RM69.99</span>
                </div>
              </div>
            </div>
            <!-- product - end -->
            ...
            <div>
              <a href="#" class="group relative mb-2 block h-80 overflow-hidden rounded-lg bg-gray-100 lg:mb-3">
                <img src="assets/img/JuiceMi.jpg" loading="lazy" alt="Photo by Charles Deluvio" class="h-full w-full object-cover object-center transition duration-200 group-hover:scale-110" />
              </a>

              <div>
                <a href="#" class="hover:gray-800 mb-1 text-gray-500 transition duration-100 lg:text-lg">JuiceMi</a>

                <div class="flex items-end gap-2">
                  <span class="font-bold text-gray-800 lg:text-lg">RM149.99</span>
                </div>
              </div>
            </div>
            <!-- product - end -->
            ...
            <div>
              <a href="#" class="group relative mb-2 block h-80 overflow-hidden rounded-lg bg-gray-100 lg:mb-3">
                <img src="assets/img/RareVape.jpg" loading="lazy" alt="Photo by Fernando Lavin" class="h-full w-full object-cover object-center transition duration-200 group-hover:scale-110" />
              </a>

              <div>
                <a href="#" class="hover:gray-800 mb-1 text-gray-500 transition duration-100 lg:text-lg">Rare Pro V2</a>
            ...
            <div>
              <a href="#" class="group relative mb-2 block h-80 overflow-hidden rounded-lg bg-gray-100 lg:mb-3">
                <img src="assets/img/E-cigarette.jpg" loading="lazy" alt="Photo by Kiran CK" class="h-full w-full object-cover object-center transition duration-200 group-hover:scale-110" />
              </a>

              <div>
                <a href="#" class="hover:gray-800 mb-1 text-gray-500 transition duration-100 lg:text-lg">E-Cigarette V3</a>

                <div class="flex items-end gap-2">
                  <span class="font-bold text-gray-800 lg:text-lg">RM79.99</span>
                </div>
              </div>
            </div>
            <!-- product - end -->
            ...
            <div>
              <a href="#" class="group relative mb-2 block h-80 overflow-hidden rounded-lg bg-gray-100 lg:mb-3">
                <img src="assets/img/ElfBar.jpg" loading="lazy" alt="Photo by Fakurian Design" class="h-full w-full object-cover object-center transition duration-200 group-hover:scale-110" />
              </a>

              <div>
                <a href="#" class="hover:gray-800 mb-1 text-gray-500 transition duration-100 lg:text-lg">ElfBar Pro</a>

                <div class="flex items-end gap-2">
                  <span class="font-bold text-gray-800 lg:text-lg">RM39.99</span>
                </div>
              </div>
            </div>
            <!-- product - end -->
    ...
    <div class="bg-white py-6 sm:py-8 lg:py-12">
        <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
        <h2 class="mb-4 text-center text-2xl font-bold text-gray-800 md:mb-8 lg:text-3xl">SHOP BY BRAND</h2>
    ...
    <div class="bg-white py-6 sm:py-8 lg:py-12">
        ...
        <div class="mb-10 md:mb-16">
            ...
            <p class="mx-auto max-w-screen-md text-center text-gray-500 md:text-lg">TOP Seller in Da World!</p>
        </div>
        <!-- text - end -->
        ...
        <div class="grid grid-cols-2 gap-4 md:grid-cols-3 lg:grid-cols-4 lg:gap-8">
            ...
            <div class="mb-2 h-24 w-24 overflow-hidden rounded-full bg-gray-200 shadow-lg md:mb-4 md:h-32 md:w-32">
                <img src="assets/img/Havertz.jpg" loading="lazy" alt="Photo by Radu Florin" class="h-full w-full object-cover object-center" />
            </div>

            <div>
                <div class="text-center font-bold text-indigo-500 md:text-lg">Kai Zavertz</div>
                <p class="mb-3 text-center text-sm text-gray-500 md:mb-4 md:text-base">Founder</p>
            ...
            <div class="flex flex-col items-center rounded-lg bg-gray-100 p-4 lg:p-8">
            <div class="mb-2 h-24 w-24 overflow-hidden rounded-full bg-gray-200 shadow-lg md:mb-4 md:h-32 md:w-32">
                <img src="{{ asset('assets/img/Mbappe.jpg') }}" loading="lazy" alt="Photo by christian ferrer" class="h-full w-full object-cover object-center" />
            </div>

            <div>
                <div class="text-center font-bold text-indigo-500 md:text-lg">Kylian Nzampe</div>
                <p class="mb-3 text-center text-sm text-gray-500 md:mb-4 md:text-base">CO Founder</p>
            ...
            <div class="flex flex-col items-center rounded-lg bg-gray-100 p-4 lg:p-8">
            <div class="mb-2 h-24 w-24 overflow-hidden rounded-full bg-gray-200 shadow-lg md:mb-4 md:h-32 md:w-32">
                <img src="assets/img/Lukaku.jpg" loading="lazy" alt="Photo by Ayo Ogunseinde" class="h-full w-full object-cover object-center" />
            </div>

            <div>
                <div class="text-center font-bold text-indigo-500 md:text-lg">Romero Lakaka</div>
                <p class="mb-3 text-center text-sm text-gray-500 md:mb-4 md:text-base">Security</p>
            ...
            <div class="flex flex-col items-center rounded-lg bg-gray-100 p-4 lg:p-8">
                <div class="mb-2 h-24 w-24 overflow-hidden rounded-full bg-gray-200 shadow-lg md:mb-4 md:h-32 md:w-32">
                    <img src="assets/img/RyanReynold.jpg" loading="lazy" alt="Photo by Ayo Ogunseinde" class="h-full w-full object-cover object-center" />
                </div>

                <div>
                    <div class="text-center font-bold text-indigo-500 md:text-lg">Ryan Reynold</div>
                    <p class="mb-3 text-center text-sm text-gray-500 md:mb-4 md:text-base">Seller</p>
    ...
    <div class="bg-white py-6 sm:py-8 lg:py-12">
        ...
        <div class="flex flex-col items-center rounded-lg bg-gray-100 p-4 sm:p-8">
            ...
            <h2 class="text-center text-xl font-bold text-indigo-500 sm:text-2xl lg:text-3xl">GET THE LATEST UPDATE FROM US!</h2>
